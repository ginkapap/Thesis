...
二上、四下： 二一高，代表一下、四上瞬間快速累積外系修課

>>四下高的原因可是是因為四上去修很多外系開的必/選修課？想要快點畢業

二下、三上：沒二一高，代表二上二下瞬間快速累積外系修課
...
```{r results='asis'}
ggplot(py$dfpic11, aes(x=年級, y=該學期必修修課比例, fill=是否被二一))+ geom_boxplot() 
```
...
-  兩者對於二一的相關性都差不多，「保留累計的特徵可以收集到比較多資訊嗎」，跟21的相關係數都很低，可能原因為被二一資料筆數太少。
