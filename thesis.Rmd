...
dfpn = dfpn[['學號','學年','學期','年級','是否被二一','累計標準化群聚指標','累計外系修課指標','累積通識被當比','累積選修被當比','累積必修被當比','f累積通識被當比','f累積選修被當比','f累積必修被當比','該學期必修修課比例','GPA']]
...
cost function&=& \sum_{i=1}^{n} Y_{i} -(\beta_0+\beta_1 X_{i}+\beta_2 Z_{i}+\beta_3 W_{i})]^2 + \lambda\sum_{i=1}^{n} \beta_i^2 
\\
