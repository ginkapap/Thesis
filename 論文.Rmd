...
從99學年度起至107學年度中，共有645511筆學生於不同學期的資料，其中學生被二一的紀錄有1283筆，由上表可知在被二一的同學之中被二一壹次的紀錄最多筆，共有716筆，被二一兩次的有200筆；三次以上則有44筆。
...
dfclass11 = dfclass11.groupby(['系別'])['班中位數'].median().reset_index(name = '必修中位數')
